...
const DailyPage: React.FC = () => {
  ...
  return (
    <PageLayout pageTitle="Home" pageIcon={Home}>
      <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden">
        {/* Confetti Effect */}
        {showConfetti && <Confetti width={width - 50} height={height} recycle={false} numberOfPieces={1000} />}

        {/* Main Content */}
        <div className="max-w-7xl mx-auto px-4 py-4">
          {/* Desktop Stats */}
          <div className="hidden lg:flex items-center gap-4 m-auto w-fit">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mt-3.5 mb-3.5">
